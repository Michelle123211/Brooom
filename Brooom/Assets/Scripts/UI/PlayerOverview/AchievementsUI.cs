...
public class AchievementsUI : MonoBehaviour
{
    ...
    public void UpdateUI(bool completeUpdate = false) {
        if (completeUpdate) { // complete update of all achievements (old ones are removed, new ones are displayed)
        ...
        } else { // each already displayed achievement is updated separately
            foreach (var achievement in achievementParent.GetComponentsInChildren<AchievementSlotUI>()) {
